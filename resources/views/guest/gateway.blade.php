...
<div class="fixed inset-0 z-[9999] bg-[#0A0F1A] flex items-center justify-center flex-col overflow-hidden m-0 p-0">
    ...
    <div class="relative z-10 glass-card bg-[#0F172A]/80 backdrop-blur-2xl border border-blue-500/20 shadow-[0_0_50px_rgba(59,130,246,0.15)] rounded-3xl p-8 sm:p-12 flex flex-col items-center max-w-md w-full mx-4 text-center transform hover:scale-[1.01] transition-transform duration-500">
        ...
        <form action="{{ route('gateway.verify') }}" method="POST" id="verify-form" class="w-full flex flex-col items-center relative">
            ...
            <div class="bg-[#1E293B] p-2.5 rounded-2xl mb-8 flex justify-center w-full overflow-hidden shadow-inner border border-slate-700/50">
